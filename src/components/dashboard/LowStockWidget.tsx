    ...
    <section className="rounded-2xl border border-gray-200/80 bg-white shadow-[0_10px_30px_-18px_rgba(15,23,42,0.28)] transition-all duration-300 hover:shadow-[0_16px_40px_-18px_rgba(15,23,42,0.32)]">
      <header className="flex items-start justify-between gap-4 border-b border-gray-100 px-7 py-6">
        ...
        {items.length > 0 && (
          <button
            onClick={onViewAll}
            className="inline-flex h-10 min-w-[104px] shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-full border border-gray-200 bg-white px-4 text-sm font-semibold text-gray-600 transition-all duration-200 hover:border-emerald-200 hover:text-emerald-700"
          >
            View All
